#
# OMNeT++/OMNEST Makefile for Project_DDoS_LADS
#
...
TARGET_DIR = .
TARGET_NAME = Project_DDoS_LADS$(D)
...
OBJS = \
    $O/SRC/CFlowAnalyzer.o \
    $O/SRC/CFlowCollector.o \
    $O/SRC/CSNMPMonitor.o \
    $O/SRC/CustomBurstSender.o \
    $O/SRC/RouterModule.o \
    $O/SRC/ServerModule.o \
    $O/SRC/TappingRouter.o \
    $O/SRC/CSNMP_m.o
